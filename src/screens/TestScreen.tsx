...
import { getExamplesCount, getSoundEnabled, saveSession, generateId, type ExampleResult } from '../data/store';
    ...
    <div className="app-container">
      ...
      <div className="expression-area">
        <div className={shaking ? 'shake' : ''}>
          <div className="expression-text">{example.a} {example.op} {example.b}</div>
        </div>
