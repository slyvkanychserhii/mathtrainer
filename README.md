...
A progressive web app (PWA) for practicing mental arithmetic. Designed for kids in grades 1–4, with 56 task types, 8 languages, and detailed statistics.

**Live:** [slyvkanychserhii.github.io/mathtrainer](https://slyvkanychserhii.github.io/mathtrainer/)

## Features

- 56 task types — addition, subtraction, multiplication, division across different digit ranges
...
- Work on Mistakes — task 56 collects wrong-answered examples from all other tasks for targeted re-practice
